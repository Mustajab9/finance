	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (count == 0l) {
			...
			try {
				...
				authorizationDtoRes.setToken(token);
				authorizationDtoRes.setId(Long.valueOf(id));
				
				Authentication auth = new UsernamePasswordAuthenticationToken(authorizationDtoRes, null);
